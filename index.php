...
<div class="col-md-4 mb-4 mb-md-0"><a class="category-item mb-4" href="shop.php"><img class="img-fluid" src="img/cat-img-2.jpg" alt=""><strong class="category-item-title">Shoes</strong></a>

<a class="category-item" href="shop.php"><img class="img-fluid" src="img/cat-img-3.jpg" alt=""><strong class="category-item-title">Watches</strong></a></div>
...
<h2 class="h5 text-uppercase mb-4">Top rated products</h2>
</header>
<div class="row">
<!-- PRODUCT-->
<?php 
     $sqlc ="SELECT * FROM `product` ORDER BY `datee` DESC LIMIT 8";
...
<div class="badge text-white badge-"></div><a class="d-block" href="detail.php?id=<?= $rowc['id'];?>"><img class="img-fluid w-100" src="img/<?=$rowc['viewimg'];?>" alt="..."></a>
...
<h6> <a class="reset-anchor" href="detail.php"><?=$rowc['name'];?></a></h6>
<p class="small text-muted">$<?=$rowc['price'];?></p>
