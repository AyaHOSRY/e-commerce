...
<li class="nav-item">
	...
	?>
<!-- Link--><a class="nav-link <?php if ($link == "/vvv/index.php") {
	echo "active";} ?>" href="index.php">Home</a>
</li>
<li class="nav-item">
<!-- Link--><a class="nav-link <?php if ($link == "/vvv/shop.php") {
	echo "active";} ?>" href="shop.php">Shop</a>
</li>
<li class="nav-item">
<!-- Link--><a class="nav-link <?php if ($link == "/vvv/cart.php") {
	echo "active";} ?>" href="cart.php">Shopping cart</a>
</li>
<li class="nav-item">
<!-- Link--><a class="nav-link <?php if ($link == "/vvv/checkout.php") {
	echo "active";} ?>" href="checkout.php">Checkout</a>
</li>
